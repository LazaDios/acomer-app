    ...
    return (
        <ScrollView style={appStyles.dashboardContainer} contentContainerStyle={{ paddingBottom: 30 }}>
            ...
            <View style={styles.infoSection}>
                ...
                <Text style={styles.infoValue}>{comanda.usuario?.nombre_completo || comanda.nombre_mesonero || 'N/A'}</Text>

                <Text style={styles.infoLabel}>Fecha/Hora:</Text>
                <Text style={styles.infoValue}>
                    {comanda.fecha_hora_comanda ? new Intl.DateTimeFormat('es-VE', { timeZone: 'America/Caracas', year: 'numeric', month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit', hour12: false }).format(new Date(comanda.fecha_hora_comanda)) : 'N/A'}
                </Text>
            </View>
