...
export const MesoneroDashboard = ({ navigation }) => {
    ...
    // ... LÓGICA DE ACTUALIZACIÓN Y MODAL (Igual que antes) ...
        ...
        return (
            <View style={[styles.orderCard, { borderColor: getStatusColor(item.estado_comanda), borderWidth: item.estado_comanda === ESTADO_FINALIZADA ? 4 : 2 }]}>
                <View style={styles.orderHeader}>
                    <Text style={styles.orderTitle}>Mesa {item.mesa} (ID: {item.comanda_id})</Text>
                ...
                <View style={styles.orderActions}>
                    <TouchableOpacity
                        style={[styles.smallButton, { backgroundColor: esEditable ? '#007bff' : '#17a2b8' }]}
                        onPress={() => {
                        ...
                        disabled={isUpdating}
                    >
                        <MaterialIcons name={esEditable ? "edit" : "visibility"} size={16} color="white" style={{marginRight: 4}} />
                        <Text style={styles.smallButtonText}>{esEditable ? 'EDITAR / AÑADIR' : 'VER'}</Text>
                    </TouchableOpacity>
                    ...
                    {item.estado_comanda === ESTADO_FINALIZADA && (
                        <TouchableOpacity
                            ...
                            disabled={isUpdating}
                        >
                            <MaterialIcons name="attach-money" size={16} color="white" style={{marginRight: 4}} />
                    ...
                    {esCancelable && (
                        <TouchableOpacity
                            style={[styles.smallButton, { backgroundColor: '#dc3545', paddingHorizontal: 8, minWidth: 40 }]}
    ...
    return (
        <View style={styles.dashboardContainer}>
            ...
            <Text style={styles.sectionTitleOperative}>Comandas Activas</Text>
